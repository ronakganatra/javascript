...
class BaseComposerHelpModal extends React.Component {
...
BaseComposerHelpModal.propTypes = {
...
BaseComposerHelpModal.defaultProps = {
	isOpen: false,
};
...
const ComposerHelpModal = styled( BaseComposerHelpModal )`
...
export default injectIntl( ComposerHelpModal );
